...
import { deleteCompanyById } from "@/utils/actions/company.actions";
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
  ...
  const onConfirm = async () => {
    ...
    try {
      const del = await deleteCompanyById(data.id);
      if (del.error) {
    ...
    <>
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => router.push(`/admin/companies/${data.id}`)}>
