...
export function JobsPageClient({ jobs, totalJobs, locations, currentPage, pageSize, searchParams }: JobsPageClientProps) {
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      <div>
        ...
        <Select value={searchParams.status || "all"} onValueChange={(value) => updateSearchParams({ status: value === "all" ? undefined : value })}>
          <SelectTrigger>
      ...
      <div>
        ...
        <div className="space-y-2">
          <Input placeholder="Min gaji" type="number" value={searchParams.salaryMin || ""} onChange={(e) => updateSearchParams({ salaryMin: e.target.value || undefined })} />
          <Input placeholder="Max gaji" type="number" value={searchParams.salaryMax || ""} onChange={(e) => updateSearchParams({ salaryMax: e.target.value || undefined })} />
        </div>
      </div>
